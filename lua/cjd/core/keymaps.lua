...
-- Bind the function to a key (e.g., <leader>rn for renaming)
keymap.set("n", "<leader>go", run_go_file, { desc = "Build and Execute binary file (GO)"})

--diff-view
keymap.set("n", "dvo", ":DiffviewOpen<CR>", { desc = "Open Diffview"})
keymap.set("n", "dvc", ":DiffviewClose<CR>", { desc = "Close Diffview"})
keymap.set("n", "dvh", ":DiffviewFileHistory %<CR>", { desc = "Show File History"})
keymap.set("n", "dvH", ":DiffviewFileHistory<CR>", { desc = "Show Project History"})
